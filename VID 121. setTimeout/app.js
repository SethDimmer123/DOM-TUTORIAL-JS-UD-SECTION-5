...
//   setTimeout(sayHello, 1000); // waits 1 second before showing up in the console.
...
//   DO NOT INVOKE THE FUNCTION
  ...
  // alternative approach of how to pass in the 
//   functionality, especially with ES6 arrow functions
  // setTimeout(function () {
  //   console.log(`hello john`);
  ...
  clearTimeout(firstID); // clears 1 of the firstID's since there are 2 