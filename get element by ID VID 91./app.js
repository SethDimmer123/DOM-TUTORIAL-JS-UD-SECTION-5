// Select the element or group of elements that i want

// Decide the affect i want to apply to the selection.


// getElementById('element')

const h1 = document.getElementById('title');
h1.style.color = 'red' // changed the color of the h1 tag
